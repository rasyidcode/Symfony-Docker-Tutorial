...
class App
{
    ...
    private string $redirectUri = 'http://oauth2-client-sample.test:8080/callback';
    private string $authServer = 'http://oauth2-server-sample.test:8080/authorize';
    private string $tokenServer = 'http://oauth2-server-sample.test:8080/token';
    private string $jwksUri = 'http://oauth2-server-sample.test:8080/.well-known/jwks.json';
    private string $apiUri = 'http://oauth2-server-sample.test:8080/api/test';
